...
interface ConfirmTripModalProps {
    ...
    closeComfirmTripModal: () => void;
    createTrip: (event: FormEvent<HTMLFormElement>) => void;
}

export function ConfirmTripModal ({ closeGuestModal, closeComfirmTripModal, createTrip }: ConfirmTripModalProps){
    return (
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] max-w-full rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            <div className='space-y-2'>
              <div className='flex items-center justify-between'>
                ...
                <button onClick={closeGuestModal}>
                  <X onClick={closeComfirmTripModal} className='size-5 text-zinc-400' />
                </button>
              </div>
            ...
            <form onSubmit={createTrip} className='space-y-3'>
              ...
              <button type="submit" className="w-full justify-center bg-lime-300 text-lime-950 px-5 h-11 font-medium flex items-center gap-2 rounded-md hover:bg-lime-400">
